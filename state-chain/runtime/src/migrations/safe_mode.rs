			...
			|maybe_old: Option<old::RuntimeSafeMode>| {
				maybe_old.map(|old| {
					...
					crate::safe_mode::RuntimeSafeMode {
						...
						broadcast_bsc:
						<pallet_cf_broadcast::PalletSafeMode<Instance8> as SafeMode>::code_green(),
						witnesser,
						...
						ingress_egress_bsc:
						<pallet_cf_ingress_egress::PalletSafeMode<Instance8> as SafeMode>::code_green(),
