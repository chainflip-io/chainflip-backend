...
use crate::{Instance6, Instance15};
            ...
            |maybe_old: Option<old::RuntimeSafeMode>| {
                maybe_old.map(|old| {
                    crate::safe_mode::RuntimeSafeMode {
                        ...
                        pools: old.pools,
                        trading_strategies: <pallet_cf_trading_strategy::PalletSafeMode as SafeMode>::CODE_GREEN,
                        ...
                        threshold_signature_polkadot: <pallet_cf_threshold_signature::PalletSafeMode<Instance15> as SafeMode>::CODE_GREEN,
                        ...
                        broadcast_assethub: <pallet_cf_broadcast::PalletSafeMode<Instance6> as SafeMode>::CODE_GREEN,
                        ...
                        ingress_egress_assethub: <pallet_cf_ingress_egress::PalletSafeMode<Instance6> as SafeMode>::CODE_GREEN,
                    }
                })
            },
        );
