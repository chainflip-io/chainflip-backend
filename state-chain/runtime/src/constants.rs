...
pub mod common {
	...
	pub const MILLISECONDS_PER_BLOCK_TRON: u64 = 3 * 1000;
	pub const MILLISECONDS_PER_BLOCK_BSC: u64 = 450;
	...
	pub const BLOCKS_PER_MINUTE_TRON: u64 = 60000 / MILLISECONDS_PER_BLOCK_TRON;
	pub const BLOCKS_PER_MINUTE_BSC: u64 = 60000 / MILLISECONDS_PER_BLOCK_BSC;
