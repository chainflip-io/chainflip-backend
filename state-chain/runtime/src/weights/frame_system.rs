...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	fn remark(_b: u32, ) -> Weight {
		...
		(Weight::ref_time(2_248_000)
)
	}
	fn remark_with_event(b: u32, ) -> Weight {
		#[allow(clippy::unnecessary_cast)]
		(Weight::ref_time(17_214_000)
)
			// Standard Error: 0
			.saturating_add((Weight::ref_time(2_000)
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		(Weight::ref_time(0)
			...
			.saturating_add((Weight::ref_time(819_000)
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		(Weight::ref_time(0)
			...
			// Standard Error: 1_000
			.saturating_add((Weight::ref_time(601_000)
).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes(i as u64))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	fn kill_prefix(p: u32, ) -> Weight {
		...
		(Weight::ref_time(0)
			...
			.saturating_add((Weight::ref_time(1_318_000)
