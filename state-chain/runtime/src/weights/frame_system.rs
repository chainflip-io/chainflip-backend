...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		(Weight::from_parts(17_214_000, 0)
			...
			// Standard Error: 0
			.saturating_add((Weight::from_parts(2_000, 0)
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		(Weight::from_parts(0, 0)
			...
			.saturating_add((Weight::from_parts(819_000, 0)
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		(Weight::from_parts(0, 0)
			...
			// Standard Error: 1_000
			.saturating_add((Weight::from_parts(601_000, 0)
).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes(i as u64))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	fn kill_prefix(p: u32, ) -> Weight {
		...
		(Weight::from_parts(0, 0)
			...
			.saturating_add((Weight::from_parts(1_318_000, 0)
