...
// impl<Cs: broker_info::Cats, Fs: broker_info::Containers<Cs>>
// Container<broker_info::Pointwise<Cs>> for Fs {     type Input = ();

//     type With<X: Object<Self::Input>> = ();

//     fn map<X: Object<Self::Input>, Y: Object<Self::Input>>(f: HomOf<Self::Input,X,Y>) ->
// <broker_info::Pointwise<Cs> as Cat>::Hom<Self::With<X>, Self::With<Y>> {         todo!()
//     }
// }
...
//     fn map<X: Object<Self::Input>, Y: Object<Self::Input>>(f: HomOf<Self::Input,X,Y>) -> <Ty as
// Cat>::Hom<Self::With<X>, Self::With<Y>> {         todo!()
//     }
// }
...
fn domap() -> HomOf<ShapeCat, RuntimeLayer, RpcLayer> {
	let map_amount: Box<dyn Fn(AssetAmount) -> u64> = Box::new(|a: AssetAmount| a as u64);
	broker_info::All {
