...
trait Object<C: Cat>: 'static {
    // type At<N: IndexForObj<Self, C::At<>>;

    type Get: 'static;
    // type GetN: AllAtIndex<C::GetN>;
...
// X::GetN<Zero> : (FiberedCat<ContainersInputs<cats, C>>::GetN<Zero>)
