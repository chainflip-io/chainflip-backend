	...
	Ok(ChainSpec::from_genesis(
		...
		move || {
			testnet_genesis(
				...
				common::CURRENT_AUTHORITY_EMISSION_INFLATION_BPS,
				common::BACKUP_NODE_EMISSION_INFLATION_BPS,
...
fn testnet_genesis(
	...
	current_authority_emission_inflation_bps: u32,
	backup_node_emission_inflation_bps: u32,
	expiry_span: u64,
