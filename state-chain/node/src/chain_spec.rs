...
const DEFAULT_ENVIRONMENT_CONFIG: EnvironmentConfig = EnvironmentConfig {
	stake_manager_address: Some(hex_literal::hex!["95D55FE52e660383391c590070844120F9f0384d"]),
	key_manager_address: Some(hex_literal::hex!["e3BC8384048C53693421643e492f494B63637b29"]),
...
pub fn get_environment() -> ([u8; 20], [u8; 20], u64) {
	let stake_manager_address: [u8; 20] = hex::decode(
		env::var("STAKE_MANAGER_ADDRESS")
			.unwrap_or(String::from("95D55FE52e660383391c590070844120F9f0384d")),
	)
	.unwrap()
	.try_into()
	...
	let key_manager_address: [u8; 20] = hex::decode(
		env::var("KEY_MANAGER_ADDRESS")
			.unwrap_or(String::from("e3BC8384048C53693421643e492f494B63637b29")),
	)
	.unwrap()
	.try_into()
	.expect("address cast failed");
