...
fn test_boost_details_serialization() {
	let boost_details_1 = BoostPoolDetails {
	...
	let boost_details_2 = BoostPoolDetails {
...
fn test_boost_fees_serialization() {
	let val: BoostPoolFeesResponse = vec![BoostPoolFeesRpc::new(
		Asset::Btc,
		10,
		BoostPoolDetails {
			available_amounts: BTreeMap::from([(ID_1.clone(), 10_000)]),
