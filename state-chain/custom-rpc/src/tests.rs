				...
				regular_network_fee: NetworkFeeDetails {
					...
					rates: any::AssetMap {
						eth: eth::AssetMap {
							...
							wbtc: Permill::from_perthousand(40),
							cbbtc: Permill::from_perthousand(40),
						},
				...
				internal_swap_network_fee: NetworkFeeDetails {
					...
					rates: any::AssetMap {
						eth: eth::AssetMap {
							...
							wbtc: Permill::from_perthousand(20),
							cbbtc: Permill::from_perthousand(20),
						},
						...
						arb: arb::AssetMap {
							...
							usdt: Permill::from_perthousand(324),
						},
						sol: sol::AssetMap {
