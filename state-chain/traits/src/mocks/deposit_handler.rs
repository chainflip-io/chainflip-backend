	...
	fn get_new_deposit_address(
		...
		(
			...
			match asset.into() {
				...
				ForeignChain::Bsc => ForeignChainAddress::Bsc([channel_id as u8; 20].into()),
				...
				ForeignChain::Tron => ForeignChainAddress::Tron([channel_id as u8; 20].into()),
			},
			Default::default(),
		)
	}
...
impl<C: Chain, T: Chainflip> DepositApi<C> for MockDepositHandler<C, T> {
	...
	fn request_swap_deposit_address(
		...
		boost_fee: BasisPoints,
		_refund_params: ChannelRefundParametersForChain<C>,
