...
use super::{
	vec, vec::Vec, AccountMeta, FromStr, Instruction, Pubkey, SYSTEM_PROGRAM_ID, ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID
};
...
impl AssociatedTokenAccountInstruction {
    ...
    pub fn create_associated_token_account_idempotent_instruction(
        ...
        //     token_program_id,
        // );
        // let instruction: AssociatedTokenAccountInstruction = AssociatedTokenAccountInstruction::CreateIdempotent;
