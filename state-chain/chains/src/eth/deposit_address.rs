...
const DEPOSIT_CONTRACT_BYTECODE_TRON: [u8; 1198] = hex_literal::hex!(
	""
);
...
pub fn get_create_2_address(
	...
	get_create_2_address_prefixed(vault_address, token_address, channel_id, ETH_PREFIX_BYTE, DEPOSIT_CONTRACT_BYTECODE)
}
...
pub fn get_create_2_address_tron(
	...
	get_create_2_address_prefixed(vault_address, token_address, channel_id, TRON_PREFIX_BYTE, DEPOSIT_CONTRACT_BYTECODE_TRON)
}
...
mod test_super {
	...
	const TRON_VAULT_ADDRESS: EthereumAddress =
		H160(hex_literal::hex!("adeecfa46eb3579c0f733085ba69a296ae9ee743"));

	const TRON_USDT_ADDRESS: EthereumAddress =
		H160(hex_literal::hex!("eca9bc828a3005b9a3b909f2cc5c2a54794de05f"));
	...
	fn test_tron_trx() {
		assert_eq!(
			...
			H160(hex_literal::hex!("d5b7d46e0266a92af97ef45befa21991878a1675"))
		);
	...
	fn test_tron_token() {
		assert_eq!(
			...
			H160(hex_literal::hex!("6a5adcf00353acb046d8491bacc1d56e59f79e42"))
		);
