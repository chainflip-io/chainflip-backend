use crate::{CcmAdditionalData, CcmChannelMetadata, ChannelRefundParameters};
use cf_primitives::{
...
pub fn build_cf_parameters<RefundAddress: Encode>(
	refund_parameters: ChannelRefundParameters<RefundAddress>,
