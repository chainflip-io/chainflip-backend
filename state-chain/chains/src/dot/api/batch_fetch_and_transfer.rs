...
mod test_batch_fetch {
	...
	use super::*;
	use crate::dot::{sr25519::Pair, NONCE_1, RAW_SEED_1, RAW_SEED_2, WESTEND_RUNTIME_VERSION};
	...
	fn create_test_api_call() {
		...
		let batch_fetch_api = BatchFetchAndTransfer::new_unsigned(
			PolkadotReplayProtection::new(NONCE_1, 0, WESTEND_RUNTIME_VERSION, Default::default()),
			dummy_fetch_params,
