...
impl BenchmarkValue for TronTransactionFee {
	fn benchmark_value() -> Self {
		Self {
			fee: 1_000_000,
			energy_usage: Some(50_000),
			energy_fee: Some(500_000),
			origin_energy_usage: Some(0),
			energy_usage_total: Some(50_000),
			net_usage: Some(300),
			net_fee: Some(500_000),
			energy_penalty_total: Some(0),
		}
	}
}
