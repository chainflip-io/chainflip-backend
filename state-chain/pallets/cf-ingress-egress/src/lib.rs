...
impl<T: Config<I>, I: 'static> Pallet<T, I> {
	...
	fn process_channel_deposit_full_witness_inner(
		...
		// We want to pass this check even if the asset is not correct -> governanceElection allows to trigger 
		// witnessing for an arbitrary asset to recover in case of asset missmatch deposit
		// ensure!(
