...
//! DATE: 2024-03-05, STEPS: `20`, REPEAT: `20`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	fn disable_asset_egress() -> Weight {
		...
		Weight::from_parts(121_000_000, 3566)
	...
	/// Storage: `EthereumIngressEgress::BoostRecords` (r:1 w:0)
	/// Proof: `EthereumIngressEgress::BoostRecords` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	fn process_single_deposit() -> Weight {
		...
		Weight::from_parts(643_000_000, 6482)
	...
	fn finalise_ingress(a: u32, ) -> Weight {
		...
		Weight::from_parts(15_494_574, 3699)
			// Standard Error: 697_882
			.saturating_add(Weight::from_parts(29_959_748, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn vault_transfer_failed() -> Weight {
		...
		//  Measured:  `1610`
		//  Estimated: `12500`
		// Minimum execution time: 885_000_000 picoseconds.
		Weight::from_parts(930_000_000, 12500)
	...
	fn ccm_broadcast_failed() -> Weight {
		...
		Weight::from_parts(142_000_000, 3925)
	...
	fn clear_prewitnessed_deposits(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_927_167, 3603)
			// Standard Error: 1_775_860
			.saturating_add(Weight::from_parts(95_633_394, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	/// Storage: `EthereumIngressEgress::BoostRecords` (r:1 w:1)
	/// Proof: `EthereumIngressEgress::BoostRecords` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `EthereumIngressEgress::DepositChannelLookup` (r:1 w:0)
	/// Proof: `EthereumIngressEgress::DepositChannelLookup` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `EthereumIngressEgress::PrewitnessedDeposits` (r:1 w:0)
	/// Proof: `EthereumIngressEgress::PrewitnessedDeposits` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `EthereumChainTracking::CurrentChainState` (r:1 w:0)
	/// Proof: `EthereumChainTracking::CurrentChainState` (`max_values`: Some(1), `max_size`: Some(40), added: 535, mode: `MaxEncodedLen`)
	/// Storage: `EthereumIngressEgress::WithheldTransactionFees` (r:1 w:1)
	...
	fn boost_deposit() -> Weight {
		...
		Weight::from_parts(426_000_000, 4359)
