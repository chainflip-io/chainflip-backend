...
//! DATE: 2023-01-20, STEPS: `2`, REPEAT: 1, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	// Storage: Reputation Reputations (r:77 w:77)
	/// The range of component `a` is `[3, 150]`.
	fn expire_epoch(_a: u32, ) -> Weight {
		// Minimum execution time: 71_000 nanoseconds.
		Weight::from_ref_time(1_971_000_000)
			.saturating_add(T::DbWeight::get().reads(380))
			.saturating_add(T::DbWeight::get().writes(379))
	}
	...
	fn start_authority_rotation(_a: u32, ) -> Weight {
		// Minimum execution time: 273_000 nanoseconds.
		Weight::from_ref_time(12_852_000_000)
			.saturating_add(T::DbWeight::get().reads(2426))
	...
	/// The range of component `a` is `[3, 150]`.
	fn rotation_phase_keygen_success(_a: u32, ) -> Weight {
		// Minimum execution time: 190_000 nanoseconds.
		Weight::from_ref_time(272_000_000)
	...
	// Storage: Validator CurrentRotationPhase (r:1 w:0)
	/// The range of component `a` is `[3, 150]`.
	fn rotation_phase_activating_keys_success(_a: u32, ) -> Weight {
...
impl WeightInfo for () {
	...
	fn expire_epoch(_a: u32, ) -> Weight {
		// Minimum execution time: 71_000 nanoseconds.
		Weight::from_ref_time(1_971_000_000)
			.saturating_add(RocksDbWeight::get().reads(380))
			.saturating_add(RocksDbWeight::get().writes(379))
	}
	// Storage: System Digest (r:1 w:0)
	// Storage: unknown [0xac56b214382d772914db46f9c4a772eda7d533d63f25202626db56d673717380] (r:1 w:1)
	// Storage: Validator CurrentAuthorities (r:1 w:0)
	...
	fn start_authority_rotation(_a: u32, ) -> Weight {
		// Minimum execution time: 273_000 nanoseconds.
		Weight::from_ref_time(12_852_000_000)
			.saturating_add(RocksDbWeight::get().reads(2426))
