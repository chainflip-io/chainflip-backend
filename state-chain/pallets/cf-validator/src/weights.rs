...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	/// Proof: `EthereumVault::PendingKeyRotation` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	/// Storage: `PolkadotVault::PendingKeyRotation` (r:1 w:1)
	/// Proof: `PolkadotVault::PendingKeyRotation` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	/// Storage: `BitcoinVault::PendingKeyRotation` (r:1 w:1)
	/// Proof: `BitcoinVault::PendingKeyRotation` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	/// Storage: `PolkadotVault::CurrentKeyEpochAndState` (r:1 w:0)
	/// Proof: `PolkadotVault::CurrentKeyEpochAndState` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: `BitcoinVault::CurrentKeyEpochAndState` (r:1 w:0)
	/// Proof: `BitcoinVault::CurrentKeyEpochAndState` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// The range of component `a` is `[3, 150]`.
	fn rotation_phase_keygen(a: u32, ) -> Weight {
		// Proof Size summary in bytes:
	...
	/// Storage: `Validator::CurrentRotationPhase` (r:1 w:1)
	/// Proof: `Validator::CurrentRotationPhase` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: `EthereumVault::PendingKeyRotation` (r:1 w:0)
	/// Proof: `EthereumVault::PendingKeyRotation` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: `PolkadotVault::PendingKeyRotation` (r:1 w:0)
	/// Proof: `PolkadotVault::PendingKeyRotation` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: `BitcoinVault::PendingKeyRotation` (r:1 w:0)
	/// Proof: `BitcoinVault::PendingKeyRotation` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// The range of component `a` is `[3, 150]`.
	fn rotation_phase_activating_keys(a: u32, ) -> Weight {
		// Proof Size summary in bytes:
