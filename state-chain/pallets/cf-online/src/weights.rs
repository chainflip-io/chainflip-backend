...
//! DATE: 2021-11-01, STEPS: `[20, ]`, REPEAT: 10, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
pub trait WeightInfo {
	fn heartbeat() -> Weight;
	fn submit_network_state(x: u32, ) -> Weight;
	fn on_initialize_no_action(x: u32, ) -> Weight;
}
...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	fn submit_network_state(x: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((53_327_000 as Weight).saturating_mul(x as Weight))
			.saturating_add(T::DbWeight::get().reads(112 as Weight))
			.saturating_add(T::DbWeight::get().writes(55 as Weight))
	}
	fn on_initialize_no_action(x: u32, ) -> Weight {
		(2_125_000 as Weight)
			// Standard Error: 0
...
impl WeightInfo for () {
	...
	fn submit_network_state(x: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 738_000
			.saturating_add((53_327_000 as Weight).saturating_mul(x as Weight))
			.saturating_add(RocksDbWeight::get().reads(112 as Weight))
			.saturating_add(RocksDbWeight::get().writes(55 as Weight))
	}
	fn on_initialize_no_action(x: u32, ) -> Weight {
		(2_125_000 as Weight)
			// Standard Error: 0
