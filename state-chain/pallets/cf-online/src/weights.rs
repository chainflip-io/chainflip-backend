...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	// Storage: Validator ValidatorLookup (r:149 w:0)
	...
	fn submit_network_state() -> Weight {
		#[allow(clippy::unnecessary_cast)]
		(3_481_000_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(303 as Weight))
	}
	fn on_initialize_no_action() -> Weight {
		#[allow(clippy::unnecessary_cast)]
		(1_000_000 as Weight)
...
impl WeightInfo for () {
	...
	fn submit_network_state() -> Weight {
		#[allow(clippy::unnecessary_cast)]
		(3_481_000_000 as Weight)
			.saturating_add(RocksDbWeight::get().reads(303 as Weight))
	}
	fn on_initialize_no_action() -> Weight {
		#[allow(clippy::unnecessary_cast)]
		(1_000_000 as Weight)
