...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	fn on_initialize(t: u32, r: u32, ) -> Weight {
		...
		//  Estimated: `12208 + r * (2864 ±0) + t * (122 ±0)`
		// Minimum execution time: 30_943_000 picoseconds.
		Weight::from_parts(31_856_000, 12208)
			// Standard Error: 82_612
			.saturating_add(Weight::from_parts(1_021_027, 0).saturating_mul(t.into()))
			// Standard Error: 82_612
			.saturating_add(Weight::from_parts(33_228_032, 0).saturating_mul(r.into()))
	...
	fn transaction_failed() -> Weight {
		...
		Weight::from_parts(34_764_000, 4656)
	...
	fn on_signature_ready() -> Weight {
		...
		//  Measured:  `1513`
		//  Estimated: `7453`
		// Minimum execution time: 90_383_000 picoseconds.
		Weight::from_parts(94_588_000, 7453)
	...
	fn start_next_broadcast_attempt() -> Weight {
		...
		Weight::from_parts(66_667_000, 7758)
	...
	fn transaction_succeeded() -> Weight {
		...
		Weight::from_parts(57_885_000, 4529)
			.saturating_add(T::DbWeight::get().reads(11_u64))
			.saturating_add(T::DbWeight::get().writes(7_u64))
	}
}
