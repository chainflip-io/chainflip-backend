...
//! DATE: 2022-06-15, STEPS: `20`, REPEAT: 10, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	// Storage: EthereumBroadcaster AwaitingTransactionSignature (r:1000 w:0)
	...
	fn on_initialize(b: u32, x: u32, ) -> Weight {
		...
		(0 as Weight)
			...
			.saturating_add((519_525_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 492_000
			.saturating_add((5_015_000 as Weight).saturating_mul(x as Weight))
