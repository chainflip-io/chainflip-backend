...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	fn on_initialize(x: u32, ) -> Weight {
		...
		Weight::ref_time(6_605_838)
			// Standard Error: 4_267
			.saturating_add(Weight::ref_time(1_301_424).saturating_mul(x.into()))
