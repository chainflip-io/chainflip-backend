...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	fn expire_pending_claims_at(b: u32, ) -> Weight {
		...
		(0 as Weight)
			...
			.saturating_add((46_467_000 as Weight).saturating_mul(b as Weight))
