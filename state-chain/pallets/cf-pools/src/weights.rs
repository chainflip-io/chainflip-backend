...
//! DATE: 2025-03-11, STEPS: `20`, REPEAT: `20`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	fn update_limit_order() -> Weight {
		...
		Weight::from_parts(55_000_000, 8211)
	...
	fn set_limit_order() -> Weight {
		...
		Weight::from_parts(56_000_000, 8211)
			.saturating_add(T::DbWeight::get().reads(7_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `LiquidityPools::Pools` (r:1 w:1)
	...
	/// Storage: `LiquidityPools::HistoricalEarnedFees` (r:2 w:2)
	/// Proof: `LiquidityPools::HistoricalEarnedFees` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `AssetBalances::FreeBalances` (r:2 w:0)
	/// Proof: `AssetBalances::FreeBalances` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn set_pool_fees() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2003`
		...
		Weight::from_parts(47_000_000, 7943)
	...
	fn set_maximum_price_impact(n: u32, ) -> Weight {
		...
		Weight::from_parts(2_595_439, 0)
			// Standard Error: 21_086
			.saturating_add(Weight::from_parts(3_760_511, 0).saturating_mul(n.into()))
	...
	fn cancel_orders_batch(n: u32, ) -> Weight {
		...
		Weight::from_parts(54_000_000, 8091)
			// Standard Error: 1_262_782
			.saturating_add(Weight::from_parts(97_061_385, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(7_u64))
			.saturating_add(T::DbWeight::get().writes(5_u64))
