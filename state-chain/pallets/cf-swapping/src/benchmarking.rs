...
mod benchmarks {
	...
	fn request_account_creation_deposit_address() {
		...
		let signer: EthereumAddress = [
			0xa8, 0xe7, 0x0d, 0x7c, 0x5e, 0xc3, 0x3c, 0x43, 0x62, 0x05, 0x1f, 0x3b, 0xe6, 0xa9,
			0x59, 0xe8, 0xeb, 0xab, 0x2c, 0x14,
		]
		.into();
		let signature_data: SignatureData = SignatureData::Ethereum {
			signature: [
				0x23, 0xc1, 0x6b, 0xf8, 0xf2, 0xf7, 0xf4, 0xa1, 0xfd, 0xdf, 0x5c, 0x13, 0xb0, 0xd0,
				0xfb, 0x25, 0xce, 0x6c, 0x4c, 0xee, 0x91, 0xb7, 0xba, 0x17, 0xcc, 0x14, 0xbb, 0x53,
				0xdc, 0x7a, 0x7b, 0x21, 0x41, 0x0e, 0xca, 0x83, 0x4c, 0xb0, 0xc4, 0x67, 0x08, 0xe5,
				0x03, 0xfa, 0xbb, 0x75, 0x26, 0xab, 0x71, 0x35, 0xa2, 0x5d, 0x3e, 0x2a, 0x93, 0x8a,
				0x1b, 0x7d, 0x82, 0x91, 0x96, 0x88, 0xe2, 0x0b, 0x1b,
			]
			.into(),
			signer,
