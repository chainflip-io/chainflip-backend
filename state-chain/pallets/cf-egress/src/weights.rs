...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	// Storage: Egress EthereumScheduledEgress (r:2 w:1)
	// Storage: Egress EthereumDisabledEgressAssets (r:1 w:0)
	// Storage: Egress EthereumScheduledIngressFetch (r:2 w:1)
	...
	fn send_ethereum_batch(n: u32, m: u32, ) -> Weight {
		...
		(128_267_000 as Weight)
			// Standard Error: 3_000
			.saturating_add((574_000 as Weight).saturating_mul(n as Weight))
			// Standard Error: 3_000
			.saturating_add((724_000 as Weight).saturating_mul(m as Weight))
