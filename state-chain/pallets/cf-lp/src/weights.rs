...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	fn request_liquidity_deposit_address() -> Weight {
		...
		Weight::from_parts(77_149_000, 5372)
	...
	fn register_lp_account() -> Weight {
		...
		Weight::from_parts(21_052_000, 4035)
	...
	/// Proof: `AssetBalances::FreeBalances` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `LendingPools::BoostPools` (r:20 w:0)
	/// Proof: `LendingPools::BoostPools` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `LendingPools::BoostedDeposits` (r:20 w:0)
	...
	fn deregister_lp_account() -> Weight {
		...
		//  Measured:  `1524`
		//  Estimated: `52014`
		// Minimum execution time: 212_589_000 picoseconds.
		Weight::from_parts(215_926_000, 52014)
	...
	fn register_liquidity_refund_address() -> Weight {
		...
		Weight::from_parts(18_457_000, 4035)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Environment::RuntimeSafeMode` (r:1 w:0)
	...
	fn purge_balances(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1871 + n * (185 ±0)`
		//  Estimated: `10290 + n * (2662 ±0)`
		// Minimum execution time: 71_796_000 picoseconds.
		Weight::from_parts(72_573_000, 10290)
			// Standard Error: 114_726
			.saturating_add(Weight::from_parts(59_145_320, 0).saturating_mul(n.into()))
...
impl WeightInfo for () {
	...
	fn deregister_lp_account() -> Weight {
		...
		// Minimum execution time: 212_589_000 picoseconds.
		Weight::from_parts(215_926_000, 52014)
			.saturating_add(ParityDbWeight::get().reads(46_u64))
			.saturating_add(ParityDbWeight::get().writes(1_u64))
	}
	/// Storage: `AccountRoles::AccountRoles` (r:1 w:0)
	/// Proof: `AccountRoles::AccountRoles` (`max_values`: None, `max_size`: None, mode: `Measured`)
