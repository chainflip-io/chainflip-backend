...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	fn request_liquidity_deposit_address() -> Weight {
		...
		Weight::from_parts(68_088_000, 5496)
	...
	fn withdraw_asset() -> Weight {
		...
		//  Measured:  `1530`
		//  Estimated: `4995`
		// Minimum execution time: 69_962_000 picoseconds.
		Weight::from_parts(74_383_000, 4995)
			.saturating_add(T::DbWeight::get().reads(11_u64))
	...
	fn register_lp_account() -> Weight {
		...
		Weight::from_parts(18_584_000, 3969)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `AccountRoles::AccountRoles` (r:1 w:1)
	/// Proof: `AccountRoles::AccountRoles` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `LiquidityPools::Pools` (r:9 w:0)
	/// Proof: `LiquidityPools::Pools` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `LiquidityProvider::FreeBalances` (r:9 w:0)
	/// Proof: `LiquidityProvider::FreeBalances` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	/// Storage: `SolanaIngressEgress::BoostPools` (r:1 w:0)
	...
	fn deregister_lp_account() -> Weight {
		...
		Weight::from_parts(102_756_000, 24437)
	...
	fn register_liquidity_refund_address() -> Weight {
		...
		Weight::from_parts(15_407_000, 3969)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
