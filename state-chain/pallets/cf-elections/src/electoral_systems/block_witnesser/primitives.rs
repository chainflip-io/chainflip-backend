...
use crate::electoral_systems::block_height_tracking::{state_machine::{IndexOf, StateMachine}, ChainProgress};
...
struct BWStateMachine<N> { _phantom: sp_std::marker::PhantomData<N> }
