...
impl<T: frame_system::Config> WeightInfo for PalletWeight<T> {
	...
	/// Storage: `Swapping::FlipToBeSentToGateway` (r:1 w:0)
	/// Proof: `Swapping::FlipToBeSentToGateway` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: `Swapping::FlipToBurn` (r:1 w:0)
	/// Proof: `Swapping::FlipToBurn` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn rewards_minted() -> Weight {
		...
		//  Measured:  `2468`
		//  Estimated: `13358`
		// Minimum execution time: 131_035_000 picoseconds.
		Weight::from_parts(134_428_000, 13358)
	...
	fn rewards_not_minted() -> Weight {
		...
		Weight::from_parts(5_112_000, 1489)
