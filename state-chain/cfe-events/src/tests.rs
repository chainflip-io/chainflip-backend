...
fn event_decoding() {
	...
	// Keygen requests
	{
		...
		check_encoding(CfeEvent::EvmKeygenRequest(keygen_request.clone()), "040100000000000000020000000801010101010101010101010101010101010101010101010101010101010101010202020202020202020202020202020202020202020202020202020202020202");
		check_encoding(CfeEvent::DotKeygenRequest(keygen_request.clone()), "050100000000000000020000000801010101010101010101010101010101010101010101010101010101010101010202020202020202020202020202020202020202020202020202020202020202");
		check_encoding(CfeEvent::BtcKeygenRequest(keygen_request.clone()), "060100000000000000020000000801010101010101010101010101010101010101010101010101010101010101010202020202020202020202020202020202020202020202020202020202020202");
	}
	...
	// Handover request
	{
		check_encoding(CfeEvent::BtcKeyHandoverRequest(KeyHandoverRequest {
			...
			}), "");
	}
	...
	// Tx broadcast requests
	{
		check_encoding(CfeEvent::EthTxBroadcastRequest(TxBroadcastRequest {
			...
			}), "");
		...
		check_encoding(CfeEvent::DotTxBroadcastRequest(TxBroadcastRequest {
			...
			}), "0a01000000010101010101010101010101010101010101010101010101010101010101010118d90784006691");
		...
		check_encoding(CfeEvent::BtcTxBroadcastRequest(TxBroadcastRequest {
			...
			}), "0b010000000101010101010101010101010101010101010101010101010101010101010101180200010717f1");
	}
	...
	// P2P registration/deregistration
	{
		...
		check_encoding(CfeEvent::PeerIdRegistered {
				...
				port: 3100,
				ip: 281472812449793,
			}, "0e01010101010101010101010101010101010101010101010101010101010101015019bb26c0eed649f636ea0e8b05a1961c8d8aa0539ea0513df17a26387b14571c0c0100007fffff00000000000000000000");

		check_encoding(CfeEvent::PeerIdDeregistered {
				account_id: AccountId::from([1; 32]), pubkey
			}, "0f01010101010101010101010101010101010101010101010101010101010101015019bb26c0eed649f636ea0e8b05a1961c8d8aa0539ea0513df17a26387b1457");
	}
}
