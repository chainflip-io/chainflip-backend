...
build-localnet() {
  ...
  SC_RPC_PORT=$INIT_RPC_PORT HEALTH_PORT=$HEALTH_PORT LOCALNET_INIT_DIR=$LOCALNET_INIT_DIR SELECTED_NODES=${SELECTED_NODES[@]} ./$LOCALNET_INIT_DIR/scripts/start-all-engines.sh
