use crate::{
    ...
    vault::{
        config::{BtcConfig, EthConfig, OxenConfig, OxenRpcConfig, VaultConfig},
...
/// Test OXEN address
pub const TEST_OXEN_ADDRESS: &str = "T6SMsepawgrKXeFmQroAbuTQMqLWyMxiVUgZ6APCRFgxQAUQ1AkEtHxAgDMZJJG9HMJeTeDsqWiuCMsNahScC7ZS2StC9kHhY";
/// Test OXEN Payment id
pub const TEST_OXEN_PAYMENT_ID: [u8; 8] = [66, 15, 162, 155, 45, 154, 73, 245];
/// Test BTC address
