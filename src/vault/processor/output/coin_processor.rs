use crate::{
    ...
    utils::bip44,
    vault::{blockchain_connection::btc::IBitcoinSend, config::VAULT_CONFIG},
};

use super::senders::{btc::BtcOutputSender, OutputSender};
...
impl<L: OutputSender, E: OutputSender, B: IBitcoinSend> OutputCoinProcessor<L, E, B> {
