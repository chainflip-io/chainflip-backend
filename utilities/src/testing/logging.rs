...
/// A custom layer for tracing that makes the logs more readable on a CLI. Adds color,
/// formatting and a list of key/value pairs while not showing spans, timestamps and other
/// clutter.
