...
pub const MAX_BATCH_SIZE_OF_VAULT_SWAP_ACCOUNT_CLOSURES: usize = 10;
...
pub const TRANSACTION_BYTES_PER_ACCOUNT: usize = 32usize;
pub const TRANSACTION_BYTES_PER_REFERENCE: usize = 1usize;
