...
const CHALLENGE_TAG: [u8; 32] = [
    0x7b, 0xb5, 0x2d, 0x7a, 0x9f, 0xef, 0x58, 0x32, 0x3e, 0xb1, 0xbf, 0x7a,
    0x40, 0x7d, 0xb3, 0x82, 0xd2, 0xf3, 0xf2, 0xd8, 0x1b, 0xb1, 0x22, 0x4f,
...
fn test_sig_verification() {
	let r = Point::from_scalar(&Scalar::from_hex("8F78522655F02F46F55103BC6EE2242E04553DAA65BF18D0E329EC6B49FD3788"));
	...
	let key = crate::multisig::KeyId(hex::decode("0259B2B46FB182A6D4B39FFB7A29D0B67851DDE2433683BE6D46623A7960D2799E").unwrap());
...
fn test_btcsig_to_raw() {
    ...
    assert_eq!(sig.to_raw(), [
        0x59, 0xb2, 0xb4, 0x6f, 0xb1, 0x82, 0xa6, 0xd4, 0xb3, 0x9f, 0xfb, 0x7a,
        0x29, 0xd0, 0xb6, 0x78, 0x51, 0xdd, 0xe2, 0x43, 0x36, 0x83, 0xbe, 0x6d,
        0x46, 0x62, 0x3a, 0x79, 0x60, 0xd2, 0x79, 0x9e, 0x62, 0x6f, 0xc9, 0x6f,
        0xf3, 0x67, 0x8d, 0x4f, 0xa2, 0xde, 0x96, 0x0b, 0x2c, 0x39, 0xd1, 0x99,
        0x74, 0x7d, 0x3f, 0x47, 0xf0, 0x15, 0x08, 0xfb, 0xbe, 0x24, 0x82, 0x5c,
        0x4d, 0x11, 0xb5, 0x43
    ]);
}
...
#[test]
fn test_challenge() {
    let public = Point::from_scalar(&Scalar::from_hex("626FC96FF3678D4FA2DE960B2C39D199747D3F47F01508FBBE24825C4D11B543"));
    let commitment = Point::from_scalar(&Scalar::from_hex("EB3F18E13AEFBF7AC9347F38B6E5D5576848B4E7927F6233222BA9286BB24F31"));
    assert_eq!(BtcSigning::build_challenge(public, commitment, &BtcSigning::signing_payload_for_test()),
