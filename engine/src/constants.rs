...
pub const BTC_RPC_USER: &str = "BTC__RPC__RPC_USER";
pub const BTC_RPC_PASSWORD: &str = "BTC__RPC__RPC_PASSWORD";

pub const BTC_BACKUP_HTTP_ENDPOINT: &str = "BTC__BACKUP_RPC__HTTP_ENDPOINT";
pub const BTC_BACKUP_RPC_USER: &str = "BTC__BACKUP_RPC__RPC_USER";
pub const BTC_BACKUP_RPC_PASSWORD: &str = "BTC__BACKUP_RPC__RPC_PASSWORD";
