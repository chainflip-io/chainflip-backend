...
use super::{
    client_inner::{LegacyKeygenData, MultisigMessage},
...
pub struct LegacyKeygenState {
    ...
    delayed_next_stage_data: Vec<(AccountId, LegacyKeygenData)>,
...
impl LegacyKeygenState {
    pub fn initiate(
        ...
        let mut state = LegacyKeygenState {
    ...
    pub fn process_keygen_message(
        ...
        match (&self.stage, msg) {
            (KeygenStage::AwaitingBroadcast1, LegacyKeygenData::Broadcast1(bc1)) => {
            ...
            (KeygenStage::AwaitingBroadcast1, LegacyKeygenData::Secret2(sec2)) => {
                slog::trace!(
                    self.logger,
            ...
            (KeygenStage::AwaitingSecret2, LegacyKeygenData::Secret2(sec2)) => {
