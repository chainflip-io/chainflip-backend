...
mod tests {
	...
	async fn test_nonstandard_version_tx() {
		// This is block 000000002f4830471b6b346578546615c031b99da5e7fabeac119b63f1843f82 from the BTC testnet, which contains a 
		// transaction with version 4294967295 (violating specs that say transaction versions should be of type i32)
		...
		let _result: Result<VerboseBlock, _> = serde_path_to_error::deserialize(jd);
	}
