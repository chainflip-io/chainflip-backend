...
async function main() {
  ...
  // TODO: Gas budget passed to EVM Vault swaps is wrong. It's correct for deposit channels
  // appendSwap("ArbUsdc", "ArbEth", testVaultSwap, true);
  // appendSwap("ArbUsdc", "Eth", testVaultSwap, true);
  // appendSwap("ArbUsdc", "Eth", testSwap, true);
  // appendSwap("ArbUsdc", "ArbEth", testSwap, true);
