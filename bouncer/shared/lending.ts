...
export async function setupLendingPools<A = []>(cf: ChainflipIO<A>): Promise<void> {
  ...
  await depositLiquidity(cf, Assets.Btc, btcFundingAmount + btcIngressFee, false, '//LP_BOOST');
