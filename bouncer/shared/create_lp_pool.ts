import { observeEvent, getChainflipApi, handleSubstrateError, assetToDecimals, hexStringToBytesArray, getAddress } from '../shared/utils';
...
export async function createLpPool(ccy: Asset, initial_price: number){
	...
	console.log("Setting up " + ccy + " pool with an initial price of " + initial_price + " USDC per " + ccy);
