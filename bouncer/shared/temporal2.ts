...
type Proposition = {
    __kind: 'then',
    then: <A>(cont: <I extends z.ZodTypeAny>(is: I, run: (i: z.infer<I>) => Proposition) => A) => A
} | {
    __kind: 'done'
}
...
function consumeUntil<I extends z.ZodTypeAny>(schema: I, inputs: any[]): [boolean, z.infer<I>, any[]] {
