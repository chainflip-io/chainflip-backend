...
zod.z.nativeEnum(ChainflipNetworks);
zod.z.union([
  zod.z.object({
...
var ss58ToHex = /* @__PURE__ */ __name((address) => `0x${Buffer.from(utilCrypto.decodeAddress(address)).toString("hex")}`, "ss58ToHex");
var jsonString = string.transform((value) => JSON.parse(value));
var depositSchema = jsonString.pipe(zod.z.object({
  amount: u128,
  asset: string,
...
var mempoolTransaction = jsonString.pipe(zod.z.object({
...
exports.approveStateChainGateway = approveStateChainGateway;
exports.approveVault = approveVault;
exports.assetChains = assetChains;
exports.assetContractIds = assetContractIds;
exports.assetDecimals = assetDecimals;
exports.broker = broker_exports;
exports.chainAssets = chainAssets;
exports.chainContractIds = chainContractIds;
exports.checkStateChainGatewayAllowance = checkStateChainGatewayAllowance;
exports.checkVaultAllowance = checkVaultAllowance;
exports.executeRedemption = executeRedemption;
exports.executeSwap = executeSwap_default;
exports.fundStateChainAccount = fundStateChainAccount;
exports.getMinimumFunding = getMinimumFunding;
exports.getRedemptionDelay = getRedemptionDelay;
