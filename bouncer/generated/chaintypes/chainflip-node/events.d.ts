...
import type {
  ...
  PalletCfValidatorDelegationDelegationPlanU128,
...
export interface ChainEvents extends GenericChainEvents {
  ...
  validator: {
    ...
    DelegationPlanUpdated: GenericPalletEvent<
      ...
      { delegator: AccountId32; plan: PalletCfValidatorDelegationDelegationPlanU128 }
    >;
  ...
  /**
   * Pallet `AssethubElections`'s events
   **/
  assethubElections: {
    /**
     * Corrupted storage was detected, and so all elections and voting has been paused.
     **/
    CorruptStorage: GenericPalletEvent<'AssethubElections', 'CorruptStorage', null>;

    /**
     * A request was made, but the pallet hasn't been initialized.
     **/
    Uninitialized: GenericPalletEvent<'AssethubElections', 'Uninitialized', null>;

    /**
     * All vote data was cleared.
     **/
    AllVotesCleared: GenericPalletEvent<'AssethubElections', 'AllVotesCleared', null>;

    /**
     * Not all vote data was cleared. *You should continue clearing votes until you receive
     * the AllVotesCleared event*.
     **/
    AllVotesNotCleared: GenericPalletEvent<'AssethubElections', 'AllVotesNotCleared', null>;
