...
async function insertSolanaKey(solKey: string) {
  ...
  // For now deriving the nonceAccounts with index seeds to find all deployed nonce accounts
  for (let i = 0; ; i++) {
